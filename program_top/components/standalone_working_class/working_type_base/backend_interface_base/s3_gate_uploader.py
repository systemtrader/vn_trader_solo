...
from program_top.components.standalone_working_class import backend_interface_base
...
class s3_gate_uploader(backend_interface_base):
	...
	def __init__(self):
		...
		self._update_period=timedelta(days=int(self._config['repeating_days']))
		self._online_root=self._config['s3_gate_address']+self._config['target_stem_path']+production_root_path+'/'
